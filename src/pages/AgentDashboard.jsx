...
const PAGE_META = {
  pipeline: { title: "Pipeline", subtitle: "Friday, August 7 · 8 active records" },
  contacts: { title: "Contacts", subtitle: "8 contacts across your book" },
  listings: { title: "Listings", subtitle: "5 properties" },
  documents: { title: "Documents", subtitle: "6 documents · 2 awaiting signature" },
  calendar: { title: "Calendar", subtitle: "6 showings scheduled" },
  ai: { title: "AI Studio", subtitle: "Draft follow-ups and listing copy" },
};
    ...
    <div style={{ fontFamily: "Inter, sans-serif", background: "#F6F7F5", minHeight: "100vh", color: "#132A40" }}>
      ...
      <div style={{ display: "flex" }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            <div>
              <div style={{ fontFamily: "Fraunces, serif", fontSize: 21, fontWeight: 500 }}>{PAGE_META[activeNav].title}</div>
              <div style={{ fontSize: 12.5, color: "#8B94A0", marginTop: 2 }}>{PAGE_META[activeNav].subtitle}</div>
            </div>
          ...
          <div style={{ padding: "24px 28px", display: "flex", gap: 24, alignItems: "flex-start" }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {activeNav === "listings" && <ListingsPage />}
              {activeNav === "documents" && <DocumentsPage />}
              {activeNav === "calendar" && <CalendarPage />}
              {activeNav === "ai" && <AIStudioPage />}
            </div>

            {/* Right rail: The Ledger - stays visible everywhere except AI Studio,
                which already uses a two-panel form+output layout of its own */}
            {activeNav !== "ai" && (
              <div
                style={{
